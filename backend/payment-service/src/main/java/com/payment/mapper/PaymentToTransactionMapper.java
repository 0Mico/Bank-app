...
public interface PaymentToTransactionMapper {
    ...
    TransactionDTO toDebitDto(Payment payment, AccountModel fromAccount, AccountModel toAccount, String referenceId, boolean hasDesc);
    ...
    TransactionDTO toCreditDto(Payment payment, AccountModel fromAccount, AccountModel toAccount, String referenceId, boolean hasDesc);
}
