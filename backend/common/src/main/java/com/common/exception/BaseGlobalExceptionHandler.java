...
/**
 * Base exception handler providing common HTTP error mappings shared across all microservices.
 */
...
public abstract class BaseGlobalExceptionHandler {
    ...
    // Added to make rndpoints return a 400 status code if a Required input param is missing
    ...
    public ResponseEntity<ErrorResponse> handleUnauthorized(UnauthorizedException ex, HttpServletRequest request) {
        log.warn("Unauthorized access attempt: {} at {}", ex.getMessage(), request.getRequestURI());
